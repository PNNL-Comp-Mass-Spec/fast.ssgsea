...
table_1 <-
   ...
   mutate(
      # BLAS
      n_signif_BLAS_0 = pmax(floor(log10(floor(fast_BLAS_0))) + 2L, 
                             1L),
      n_signif_BLAS_1 = pmax(floor(log10(floor(fast_BLAS_1))) + 2L, 
                             1L),
      ...
      # OpenBLAS
      n_signif_OpenBLAS_0 = pmax(floor(log10(floor(fast_OpenBLAS_0))) + 2L, 
                                 1L),
      n_signif_OpenBLAS_1 = pmax(floor(log10(floor(fast_OpenBLAS_1))) + 2L, 
                                 1L),
