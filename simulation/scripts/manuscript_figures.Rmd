...
# 10,000 permutations
pa <- filter(time_res, nperm == "10,000") %>%
  plot_time(y_breaks = seq(0, 2, 0.5))

# 100,000 permutations
pb <- filter(time_res, nperm == "100,000") %>%
  plot_time(y_breaks = seq(0, 5, 1))

# 1,000,000 permutations
pc <- filter(time_res, nperm == "1,000,000") %>%
  plot_time(y_breaks = seq(0, 35, 10))
